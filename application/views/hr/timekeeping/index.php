<div class="row">
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <a style="width: 50%" href="#" class="btn btn-primary btn-md float-left">HOLIDAY CALENDAR</a>
...
<div class="row">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <a style="width: 50%" href="#" class="btn btn-primary btn-md float-left">REPORTS</a>
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <a style="width: 50%" href="#" class="btn btn-primary btn-md float-left">RAW DATA</a>
