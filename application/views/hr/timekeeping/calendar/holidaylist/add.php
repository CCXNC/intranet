<div class="card">
    <div class="card-header"><h4>ADD HOLIDAY<a href="<?php echo base_url(); ?>calendar/calendar_list" title="Go Back" id="back" class="btn btn-info float-right" style="margin-right:10px;">BACK</a></h4></div>
    <div class="card-body">
