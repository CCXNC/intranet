<div class="card">
    <div class="card-header"><h4>EDIT OB FORM<a href="<?php echo base_url(); ?>reports/index_ob" title="Go Back to Menu" class="btn btn-dark float-right" style="border:1px solid #ccc; margin-right:10px;">BACK</a></h4></div>
    <div class="card-body">
