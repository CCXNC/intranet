                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="ot_type[]" class="form-control">
                            ...
                            <option value="RD|RH">RESTDAY + REGULAR HOLIDAY</option>
                            <option value="RD|SH">RESTDAY + SPECIAL HOLIDAY</option>
                            <option value="RH|SH">REGULAR HOLIDAY + SPECIAL HOLIDAY</option>
                            <option value="RD|RH|SH">RESTDAY + REGULAR HOLIDAY + SPECIAL HOLIDAY</option>
                        </select>        
                    </div>
                </div>
                <div class="col-md-3">
