...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td  bgcolor="#003060"  align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
			padding-top: 25px;
			color: #ffffff;
			font-family: sans-serif; padding-bottom: 25px;" class="header">
				BLAINE INTRANET
		</td>
	</tr>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">202010100</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">RRLC</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">100000009</li>
                        </ul>
                    </div>
                    <br>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">24-Jul-2021</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">John Matthew Cruz</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <tr>
        <td align="" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
			padding-top: 25px; 
			color: #000000;
			font-family: sans-serif;" class="paragraph">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">SAMPLE REQUEST FULFILLMENT</li>
                        </ul>
                    </div>
                </div>
            </div>
