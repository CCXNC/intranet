...
<div class="row">
    <div class="col-sm-6">
        <div class="card" style="background-color:#E9FAFD">
            ...
            <div class="card-body">
                <a style="width: 100%; background-color:#18A558; border:white" href="<?php echo base_url(); ?>procurement/report_matsource_add" class="btn btn-primary btn-md float-left"><h4>With Matsource</h4></a>
