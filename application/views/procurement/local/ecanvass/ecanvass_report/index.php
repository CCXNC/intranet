...
<div class="row">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <a style="width: 70%" href="<?php echo base_url(); ?>procurement/report_matsource_add" class="btn btn-primary btn-md float-left">WITH MATSOURCE</a>
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <a style="width: 70%" href="<?php echo base_url(); ?>procurement/report_pr_add" class="btn btn-primary btn-md float-left">PR ONLY</a>
                <i style="" class="fa fa-file-alt fa-2x float-right"></i>
            </div>
        </div>
    </div>
