...
<div class="card" style="font-size:12px;">
    ...
    <div class="card-body">
        ...
        <form method="post" action="<?php echo base_url(); ?>procurement/add_quotation/<?php echo $canvass->canvass_no; ?>" enctype="multipart/form-data">
            ...
            <br>
            <input type="submit"  style="margin-left:10px;" class="float-right btn btn-info btn-sm" value="Next">
            <input class="btn btn-success btn-sm float-right" title="Add Form" type="button" name="add" id="fadd" value="Add Materials">
        </form>
    </div>
</div>
