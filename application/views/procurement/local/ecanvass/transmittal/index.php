<div class="card-header" style="background-color: #0C2D48; color: white"><h4>TRANSMITTAL<a href="<?php echo base_url(); ?>procurement/ecanvass_index" id="back" title="Go Back" class="btn btn-info float-right" style="margin-right:10px;">BACK</a></h4></div>
<br>
<div class="row">
    <div class="col-sm-6">
        <div class="card mx-auto" style="background-color:#E9FAFD; width:80%;">
            ...
            <div class="card-body">
                <a style="width: 100%; background-color:#18A558; border:white" href="<?php echo base_url(); ?>procurement/transmittal_matsource_add" class="btn btn-primary btn-md float-left"><h4>With Matsource Request</h4></a>
