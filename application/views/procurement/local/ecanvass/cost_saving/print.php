...
<!-- PRINTABLE AREA -->
<div class="card printable-page" style="font-size:12px" id="printableArea">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-10">
            ...
            <div class="card-body" style="margin-bottom:-25px; margin-top:-10px; font-size:10px">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><b>Company:</b> <?php if($canvass->company == 0) { echo 'Refamed Research Laboratory Corporation'; } else { echo 'Blaine Manufacturing Corporation'; } ?></p>
                            ...
                            <?php if($supplier_materials) : ?>  
                                <?php foreach($supplier_materials as $supplier_material) : ?> 
                                    <?php if($supplier_material->material_id == $material->id) : ?> 
                                        ...
                                        <td style="vertical-align: middle; padding: 2px;"><?php if($supplier_material->price_per_unit == 0) { echo '-';} else { $total_per_unit = number_format($supplier_material->price_per_unit, 2, '.', ','); echo $total_per_unit .'<br> <p style="font-size:10px; vertical-align: middle; padding: 2px;">'. $material->currency. '/' .$material->uom. '</p>';  } ?></td>
                                    <?php endif; ?> 
                                <?php endforeach; ?>    
                            <?php endif; ?>  
                        </tr>
