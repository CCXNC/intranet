...
<div class="card printable-page" style="font-size:12px" id="printableArea">
    <div class="row">
        <p style="text-align:center"><img class="card-img-top" style="width:40%" src="<?php echo base_url(); ?>assets/images/header.png" alt=""></p>
    </div>
    <div class="card-header" style="padding-top: 10px; padding-bottom: -100px">
        <center>
    ...
    <div style="color:red"><?php echo validation_errors(); ?> </div>
        ...
        <br>
        <table class="table table-bordered" style="font-size:12px; line-height:9px; text-align: center;">
            <thead>
