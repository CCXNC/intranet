<div class="card">
    <div class="card-header" title="Go Back" style="background-color: #0C2D48; color: white"><h4>EDIT 5S SHARE MY IDEA<a href="<?php echo base_url(); ?>fives/idea" class="btn btn-info float-right" style="margin-right:10px;">BACK</a></h4></div>
    <div class="card-body">
