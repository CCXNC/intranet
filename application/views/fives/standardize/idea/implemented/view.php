...
<div class="card">
    <div class="card-header" style="background-color: #0C2D48; color: white"><h4>VIEW 5S SHARE IMPLEMENTED IDEA<a href="<?php echo base_url(); ?>fives/implemented" id="back" title="Go Back" class="btn btn-info float-right" style="margin-right:10px;">BACK</a><input type="submit"  class="btn btn-info float-right" style="margin-right:10px;" id="printButton" title="Print Idea" value="PRINT"></h4></div>
    <div class="card-body">
        <div class="card">
