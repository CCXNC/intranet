...
<div class="card-header container-fluid" style="background-color: #0C2D48; color: white">
    <div class="row">
        <div class="col-md-9">
            <h3 class="">5S SHARE MY IDEA LIST</h3>
        </div>
        <div class="col-md-3 float-right">
            <button class="btn btn-md btn-info" title="View Implemented Ideas" style="" onclick="location.href='<?php echo base_url(); ?>fives/implemented'">IMPLEMENTED</button>
            <button class="btn btn-md btn-info" title="Add Idea" style="margin-left: .3em;" onclick="location.href='<?php echo base_url(); ?>fives/idea_add'">ADD</button>
        </div>
    </div>
</div>
<br>
