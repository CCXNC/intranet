<div class="card">
    <div class="card-header" style="background-color: #0C2D48; color: white"><h4>5S SHARE MY IDEA <a href="<?php echo base_url(); ?>fives/idea" class="btn btn-info float-right" title="Go Back" style="margin-right:10px;">BACK</a></h4></div>
    <div class="card-body">
        ...
        <form method="post" action="<?php echo base_url(); ?>fives/edit_status/<?php echo $idea->control_number; ?>/<?php echo $idea->status; ?>" enctype="multipart/form-data">
            <div class="card">
                <div class="card-header" style="background-color: #0C2D48; color: white">EDIT STATUS FORM</div>
                <div class="card-body">
