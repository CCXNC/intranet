<div class="card">
    <div class="card-header" style="background-color: #0C2D48; color: white"><h4>EDIT LOCATION DIRECTORY<a href="<?php echo base_url(); ?>productivity/index_location_directory" title="Go Back" class="btn btn-info float-right" style="margin-right:10px;">BACK</a></h4></div>
    <div class="card-body">
